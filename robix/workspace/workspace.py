...
plt.xlim(-300, 300)
plt.ylim(-5, 250)
plt.savefig('vista_lateral.png', dpi=600, transparent=True, bbox_inches='tight')
plt.show()
...
plt.xlim(-300, 300)
plt.ylim(-300, 300)
plt.savefig('vista_superior.png', dpi=600, transparent=True, bbox_inches='tight')
plt.show()
...
plt.savefig('perspectiva.png', dpi=600, transparent=True, bbox_inches='tight')
plt.show()